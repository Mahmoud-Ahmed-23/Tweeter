...
namespace Tweeter.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250705152202_Add NormalizedContent to Tweet and Retweet For Searching")]
    partial class AddNormalizedContenttoTweetandRetweetForSearching
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tweeter.Core.Domain.Entities.Data.Retweet", b =>
                {
                    ...
                    b.Property<string>("NormalizedComment")
                        ...
                        .HasColumnType("nvarchar(max)")
                        .HasComputedColumnSql("UPPER(Comment)", true);
            ...
            modelBuilder.Entity("Tweeter.Core.Domain.Entities.Data.Tweet", b =>
                {
                    ...
                    b.Property<string>("NormalizedContent")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("nvarchar(max)")
                        .HasComputedColumnSql("UPPER(Content)", true);
            ...
            modelBuilder.Entity("Tweeter.Core.Domain.Entities.Identity.ApplicationUser", b =>
                {
                    b.OwnsMany("Tweeter.Core.Domain.Entities.Identity.RefreshToken", "RefreshTokens", b1 =>
                        {
